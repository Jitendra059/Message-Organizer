...
public class bank {
	...
	private void initialize() {
		...
		//path ="D://file//otp";
		try {
			File file = new File("D://file//bank");
		...
		JLabel lblNewLabel = new JLabel("THE BANK TRANSACTION DETAILS ARE ");
		lblNewLabel.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 16));
		lblNewLabel.setBounds(37, 11, 330, 36);
...
//				System.out.println(path);
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\JITENDRA SAH\\Downloads\\aab9.jpg"));
		lblNewLabel_1.setBounds(-13, -13, 2903, 1824);
