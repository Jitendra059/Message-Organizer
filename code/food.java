...
public class food {
	...
	private void initialize() {
		...
		//path ="D://file//otp";
		try {
			File file = new File("D://file//food");
		...
		JLabel lblNewLabel = new JLabel("THE ORDERED FOOD DETAILS ARE ");
		...
		button1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				food_details v1 = new food_details();
...
//				System.out.println(path);
		...
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\JITENDRA SAH\\Downloads\\aab8.jpg"));
		lblNewLabel_1.setBounds(-15, -44, 562, 368);
